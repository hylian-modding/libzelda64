...
SYMBOL_VERSION_CONFIG(SkelAnime_Init, 0x8008C684, 0x80000180);
...
SYMBOL_VERSION_CONFIG(SkelAnime_InitFlex, 0x8008C788, 0x80000180);
...
SYMBOL_VERSION_CONFIG(SkelAnime_InitLink, 0x8008BB08, 0x80000180);
...
SYMBOL_VERSION_CONFIG(SkelAnime_ChangeAnim, 0x8008D17C, 0x80000180);
...
SYMBOL_VERSION_CONFIG(SkelAnime_DrawOpa, 0x8008993C, 0x80000180);
...
SYMBOL_VERSION_CONFIG(SkelAnime_DrawFlexOpa, 0x8008993C, 0x80000180);
...
SYMBOL_VERSION_CONFIG(SkelAnime_DrawFlexLod, 0x800894A4, 0x80000180);

extern int16_t Animation_GetLength(void* animation);
SYMBOL_VERSION_CONFIG(Animation_GetLength, 0x8008A158, 0x80000180);
