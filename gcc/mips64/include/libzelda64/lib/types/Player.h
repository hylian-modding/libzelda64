...
#define	PLAYER_ACTION_DONT_CARRY		    (PLAYER_ACTION_DOWN | PLAYER_ACTION_POWER_KIRU | PLAYER_ACTION_FALL | PLAYER_ACTION_JUMP_CLIMB | PLAYER_ACTION_JUMP | PLAYER_ACTION_FREEFALL | PLAYER_ACTION_SUBJECT | PLAYER_ACTION_LADDER) 	
