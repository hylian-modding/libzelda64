...
SYMBOL_VERSION_CONFIG(Audio_PlaySoundAtPosition, 0x80058FF8, 0x80000180);
...
SYMBOL_VERSION_CONFIG(Audio_SetBGM, 0x800CAA70, 0x80000180);

extern void Audio_PlayActorSound2(struct Actor* actor, uint16_t sfxId);
SYMBOL_VERSION_CONFIG(Audio_PlayActorSound2, 0x80022FD0, 0x80000180);
