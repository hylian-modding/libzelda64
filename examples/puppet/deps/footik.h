...
void FootIK(GlobalContext* globalCtx, entity_t* this, SkelAnime* skelAnime, Vec3f* pos, Vec3s* rot, int32_t thighLimbIndex, int32_t shinLimbIndex, int32_t footLimbIndex) {
    Vec3f spA4;
    Vec3f sp98;
    Vec3f footprintPos;
