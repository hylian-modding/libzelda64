...
volatile ooto_sync_object_t sync_entries[] = {
    ...
    SYNC_RAW("body_angle", OFFSETOF(Player, bodyAngle), OFFSETOF(En_Puppet, puppet.bodyAngle), sizeof(vec3s_t)),
    ...
    SYNC_RAW_NO_LINK("ears", 0x803AF180, OFFSETOF(En_Puppet, puppet.bunnyHoodRot), (sizeof(vec3s_t) * 2)),
