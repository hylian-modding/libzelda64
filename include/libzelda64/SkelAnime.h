...
SYMBOL_VERSION_CONFIG(SkelAnime_DrawLimbLod, 0x80088DF0, 0x80088DF0);
...
SYMBOL_VERSION_CONFIG(SkelAnime_DrawLod, 0x8008902C, 0x8008902C);
...
SYMBOL_VERSION_CONFIG(SkelAnime_DrawFlexLimbLod, 0x8008921C, 0x8008921C);
...
SYMBOL_VERSION_CONFIG(SkelAnime_DrawFlexLod, 0x800894A4, 0x800894A4);
...
SYMBOL_VERSION_CONFIG(SkelAnime_DrawLimbOpa, 0x8008971C, 0x8008971C);
...
SYMBOL_VERSION_CONFIG(SkelAnime_DrawOpa, 0x8008993C, 0x8008993C);
...
SYMBOL_VERSION_CONFIG(SkelAnime_DrawFlexLimbOpa, 0x80089B1C, 0x80089B1C);
...
SYMBOL_VERSION_CONFIG(SkelAnime_DrawFlexOpa, 0x80089D8C, 0x80089D8C);

#ifdef GAME_MM
//extern  SkelAnime_DrawFlexLimbOpaSC();
//SYMBOL_VERSION_CONFIG(SkelAnime_DrawFlexLimbOpaSC, 0xDEADBEEF, 0x80135BB8);

//extern  SkelAnime_DrawFlexOpaSC();
//SYMBOL_VERSION_CONFIG(SkelAnime_DrawFlexOpaSC, 0xDEADBEEF, 0x80135E30);
#endif

extern int32_t SkelAnime_GetFrameData(struct LegacyAnimationHeader* animation, int32_t frame, Vec3s* frameTable);
SYMBOL_VERSION_CONFIG(SkelAnime_GetFrameData, 0x80089FF0, 0x80089FF0);

extern int16_t Animation_GetLength(void* animation);
//SYMBOL_VERSION_CONFIG(Animation_GetLength, 0x8008A158, 0x80134748);
SYMBOL_VERSION_CONFIG(Animation_GetLength, 0x8008A158, 0x8008A158);

extern int16_t Animation_GetLastFrame(void* animation);
SYMBOL_VERSION_CONFIG(Animation_GetLastFrame, 0x8008A194, 0x8008A194);
...
SYMBOL_VERSION_CONFIG(SkelAnime_DrawLimb, 0x8008A1DC, 0x8008A1DC);
...
SYMBOL_VERSION_CONFIG(SkelAnime_Draw, 0x8008A414, 0x8008A414);
...
SYMBOL_VERSION_CONFIG(SkelAnime_DrawFlexLimb, 0x8008A608, 0x8008A608);
...
SYMBOL_VERSION_CONFIG(AnimationContext_SetCopyTrue, 0x8008B698, 0x8008B698);
...
SYMBOL_VERSION_CONFIG(AnimationContext_SetCopyFalse, 0x8008B708, 0x8008B708);
...
SYMBOL_VERSION_CONFIG(LinkAnimation_Change, 0x8008C000, 0x8008C000);
...
SYMBOL_VERSION_CONFIG(LinkAnimation_PlayOnce, 0x8008C178, 0x8008C178);
...
SYMBOL_VERSION_CONFIG(LinkAnimation_PlayOnceSetSpeed, 0x8008C1D8, 0x8008C1D8);
...
SYMBOL_VERSION_CONFIG(LinkAnimation_PlayLoop, 0x8008C23C, 0x8008C23C);
...
SYMBOL_VERSION_CONFIG(LinkAnimation_PlayLoopSetSpeed, 0x8008C298, 0x8008C298);

extern void LinkAnimation_CopyJointToMorph(struct GlobalContext* globalCtx, SkelAnime* skelAnime);
SYMBOL_VERSION_CONFIG(LinkAnimation_CopyJointToMorph, 0x8008C2F8, 0x8008C2F8);

extern void LinkAnimation_CopyMorphToJoint(struct GlobalContext* globalCtx, SkelAnime* skelAnime);
SYMBOL_VERSION_CONFIG(LinkAnimation_CopyMorphToJoint, 0x8008C328, 0x8008C328);
...
SYMBOL_VERSION_CONFIG(LinkAnimation_LoadToMorph, 0x8008C358, 0x8008C358);
...
SYMBOL_VERSION_CONFIG(LinkAnimation_LoadToJoint, 0x8008C39C, 0x8008C39C);

extern void LinkAnimation_InterpJointMorph(struct GlobalContext* globalCtx, SkelAnime* skelAnime, float frame);
SYMBOL_VERSION_CONFIG(LinkAnimation_InterpJointMorph, 0x8008C3E0, 0x8008C3E0);
...
SYMBOL_VERSION_CONFIG(LinkAnimation_BlendToJoint, 0x8008C418, 0x8008C418);
...
SYMBOL_VERSION_CONFIG(LinkAnimation_BlendToMorph, 0x8008C4B8, 0x8008C4B8);

extern void LinkAnimation_EndLoop(SkelAnime* skelAnime);
SYMBOL_VERSION_CONFIG(LinkAnimation_EndLoop, 0x8008C558, 0x8008C558);

extern int32_t Animation_OnFrameImpl(SkelAnime* skelAnime, float frame, float updateRate);
SYMBOL_VERSION_CONFIG(Animation_OnFrameImpl, 0x8008C57C, 0x8008C57C);

extern int32_t LinkAnimation_OnFrame(SkelAnime* skelAnime, float frame);
SYMBOL_VERSION_CONFIG(LinkAnimation_OnFrame, 0x8008C634, 0x8008C634);
...
SYMBOL_VERSION_CONFIG(SkelAnime_Init, 0x8008C684, 0x8008C684);
...
SYMBOL_VERSION_CONFIG(SkelAnime_InitFlex, 0x8008C788, 0x8008C788);
...
SYMBOL_VERSION_CONFIG(SkelAnime_InitSkin, 0x8008C894, 0x8008C894);

extern void SkelAnime_SetUpdate(SkelAnime* skelAnime);
SYMBOL_VERSION_CONFIG(SkelAnime_SetUpdate, 0x8008C974, 0x8008C974);

extern int32_t SkelAnime_Update(SkelAnime* skelAnime);
SYMBOL_VERSION_CONFIG(SkelAnime_Update, 0x8008C9C0, 0x8008C9C0);

extern int32_t SkelAnime_Morph(SkelAnime* skelAnime);
SYMBOL_VERSION_CONFIG(SkelAnime_Morph, 0x8008C9E4, 0x8008C9E4);

extern int32_t SkelAnime_MorphTaper(SkelAnime* skelAnime);
SYMBOL_VERSION_CONFIG(SkelAnime_MorphTaper, 0x8008CAA4, 0x8008CAA4);

extern void SkelAnime_AnimateFrame(SkelAnime* skelAnime);
SYMBOL_VERSION_CONFIG(SkelAnime_AnimateFrame, 0x8008CC2C, 0x8008CC2C);

extern int32_t SkelAnime_LoopFull(SkelAnime* skelAnime);
SYMBOL_VERSION_CONFIG(SkelAnime_LoopFull, 0x8008CD74, 0x8008CD74);

extern int32_t SkelAnime_LoopPartial(SkelAnime* skelAnime);
SYMBOL_VERSION_CONFIG(SkelAnime_LoopPartial, 0x8008CE14, 0x8008CE14);

extern int32_t SkelAnime_Once(SkelAnime* skelAnime);
SYMBOL_VERSION_CONFIG(SkelAnime_Once, 0x8008CEBC, 0x8008CEBC);
...
SYMBOL_VERSION_CONFIG(Animation_ChangeImpl, 0x8008CFC0, 0x8008CFC0);
