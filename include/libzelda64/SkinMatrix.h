...
SYMBOL_VERSION_CONFIG(SkinMatrix_SetTranslate, 0x8008F82C, 0x80000180);

extern void SkinMatrix_SetScale(MtxF* mf, float x, float y, float z);
SYMBOL_VERSION_CONFIG(SkinMatrix_SetScale, 0x8008F4A8, 0x80000180);

extern void SkinMatrix_MtxFMtxFMult(MtxF* mfB, MtxF* mfA, MtxF* dest);
SYMBOL_VERSION_CONFIG(SkinMatrix_MtxFMtxFMult, 0x8008EDB8, 0x80000180);

extern Mtx* SkinMatrix_MtxFToNewMtx(struct GraphicsContext* gfxCtx, MtxF* src);
SYMBOL_VERSION_CONFIG(SkinMatrix_MtxFToNewMtx, 0x8008FC98, 0x80000180);
