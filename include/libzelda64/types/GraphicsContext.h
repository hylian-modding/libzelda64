...
typedef struct GraphicsContext {
    ...
    /* 0x0008 */ Gfx* polyLineOpaBuffer;
    /* 0x000C */ Gfx* polyLineXluBuffer;
    /* 0x0010 */ Gfx* polyOvlBuffer;
    /* 0x0014 */ Gfx* gfxSave;
    /* 0x0018 */ GraphicsMessage message;
    /* 0x0038 */ OSMesg msgBuff[8]; // This is the reply buffer (decomp's name is unclear)
    /* 0x0058 */ OSMesgQueue* schedMesgQ;
...
typedef struct GraphicsContext {
    ...
    /* 0x008 */ Gfx* polyLineOpaBuffer;
    /* 0x00C */ Gfx* polyLineXluBuffer; // Assuming polyLineXlu using oot context
    /* 0x010 */ Gfx* polyOvlBuffer;
    /* 0x014 */ char pad14[0x24];
    /* 0x038 */ GraphicsMessage message;
    /* 0x058 */ OSMesgQueue* schedMesgQ;
    ...
    /* 0x2C8 */ uint32_t gfxPoolIdx;
    /* 0x2CC */ uint16_t* curFrameBuffer;
    /* 0x2D0 */ uint16_t* curRenderBuffer; // possibly just the padding described in mm decomp
