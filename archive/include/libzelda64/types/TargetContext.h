...
typedef struct TargetContext {
    ...
    /* 0x8C */ struct Actor* arrowRequestActor;
    /* 0x90 */ struct Actor* enemyBGMActor;
    /* 0x94 */ struct Actor* nextActor; // next candidate for  the arrowRequestActor
} TargetContext;                        /* sizeof = 0x98 */
